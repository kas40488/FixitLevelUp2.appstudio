...
const cacheName = 'Katie_Sullivan_Fixit_LevelUp_Level_2-2020-09-20 11:57:34.104537'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Katie_Sullivan_Fixit_LevelUp_Level_2'.length) === 'Katie_Sullivan_Fixit_LevelUp_Level_2') {
